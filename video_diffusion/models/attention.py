    ...
    def forward(
        ...
        if clip_length is not None:
            ...
            if len(SparseCausalAttention_index) > 0:
                # ----------------------------------------------------------------
                # SparseCausalAttention_index = [-1, 'last']
                # SparseCausalAttention_index = [0, 'first']
                # SparseCausalAttention_index = [1, -1]
                # SparseCausalAttention_index = [1, 2, -1, -2]
                # SparseCausalAttention_index = [1, 2, 3, -1, -2, -3]
                # ----------------------------------------------------------------
                # breakpoint()
