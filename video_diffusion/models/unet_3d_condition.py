        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if up_ft_indices is not None:
                ...
                if timestep == 301 and i in up_ft_indices:
                    torch.save(sample.detach(), os.path.join(ft_path, f'inversion_feature_{timestep}.pt'))
        # 6. post-process
...
def load_mask(mask_path='/home/lzh/code/todo/Make-A-Protagonist/kitten_mask', ):
    # 读取所有图片并转换为张量
