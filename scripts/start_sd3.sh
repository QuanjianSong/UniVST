...
CUDA_VISIBLE_DEVICES=1 python src/sd3/run_content_inversion_sd3.py \
                        --pretrained_model_path /data/lxy/sqj/base_models/stable-diffusion-3.5-medium \
...
CUDA_VISIBLE_DEVICES=2 python src/mask_propagation.py \
                        --feature_path results/contents-inv/sd3/mallard-fly/features/inversion_feature_map_15_block_5_step.pt \
                        --backbone 'sd3' \
...
#                         --content_inv_path results/contents-inv/sd3/mallard-fly/inversion \
#                         --style_inv_path results/styles-inv/sd3/00033/inversion \
