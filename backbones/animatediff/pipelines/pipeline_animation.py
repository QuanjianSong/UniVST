...
from backbones.animatediff.models.sparse_controlnet import SparseControlNetModel
from backbones.animatediff.pnp_utils import register_time, latent_adain
...
class AnimationPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        return AnimationPipelineOutput(images=video)
